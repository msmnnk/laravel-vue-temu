...
export default {
    ...
    methods: {
        submitForm() {
            ...
            axios.post(route('api.products.create', formData))
            .then(response => {
                Swal.fire({
                    icon: 'success',
        ...
        <div class="container mt-5">
            ...
            <form @submit.prevent="submitForm()">
                <div class="form-group">
                    ...
                    <input v-model="title" type="text" class="form-control" id="title" placeholder="Enter product title"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input v-model="stock" type="number" class="form-control" id="stock" placeholder="Enter product stock"
                        required>
                </div>
